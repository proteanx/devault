...
TEST_CASE("bloom_create_insert_serialize") {
  ...
  int i = 0;
  for (auto s : stream) {
    BOOST_CHECK_EQUAL(s, expected[i++]);
  }
...
TEST_CASE("bloom_create_insert_serialize_with_tweak") {
  BasicTestingSetup setup;
...
TEST_CASE("bloom_create_insert_key") {
  BasicTestingSetup setup;
...
TEST_CASE("bloom_match") {
  ...
  uint8_t ch[] = {
      };
  ...
  filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
  filter.insert(ParseHex("04943fdd508053c75000106d3bc6e2754dbcff19"));
  BOOST_CHECK_MESSAGE(filter.MatchAndInsertOutputs(tx), "Simple Bloom filter didn't match output address");
  BOOST_CHECK_MESSAGE(!filter.MatchAndInsertOutputs(spendingTx), "Simple Bloom filter matched unrelated output");
  BOOST_CHECK_MESSAGE(filter.MatchInputs(spendingTx), "Simple Bloom filter didn't add output");
  ...
  filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
  filter.insert(COutPoint(TxId(uint256S("0x90c122d70786e899529d71dbeba91ba216982fb"
                                        "6ba58f3bdaab65e73b7e9260b")),
                          0));
  BOOST_CHECK_MESSAGE(filter.IsRelevantAndUpdate(tx), "Simple Bloom filter didn't match COutPoint");

  filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
  COutPoint prevOutPoint(TxId(uint256S("0x90c122d70786e899529d71dbeba91ba216982fb6"
  ...
  filter.insert(COutPoint(TxId(uint256S("0x90c122d70786e899529d71dbeba91ba216982fb"
                                        "6ba58f3bdaab65e73b7e9260b")),
                          1));
  BOOST_CHECK_MESSAGE(!filter.IsRelevantAndUpdate(tx), "Simple Bloom filter matched COutPoint for an output "
                                                       "we didn't care about");

  filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
  filter.insert(COutPoint(TxId(uint256S("0x000000d70786e899529d71dbeba91ba216982fb"
                                        "6ba58f3bdaab65e73b7e9260b")),
                          0));
  BOOST_CHECK_MESSAGE(!filter.IsRelevantAndUpdate(tx), "Simple Bloom filter matched COutPoint for an output "
                                                       "we didn't care about");
...
TEST_CASE("merkle_block_1") {
  // Random real block
  // (0000000000013b8ab2cd513b0261a14096412195a72a0c4827d229dcc7e0f7af)
  // With 9 txes
  CBlock block;
  CDataStream stream(ParseHex("0100000090f0a9f110702f808219ebea1173056042a714bad51b916cb680000000"
  ...
  auto pair = merkleBlock.vMatchedTxn[0];
  ...
  BOOST_CHECK(merkleBlock.vMatchedTxn[0].second == uint256S("0xdd1fd2a6fc16404faf339881a90adbde7f4f728691ac62e8f16"
                                                            "8809cdfae1053"));
...
TEST_CASE("merkle_block_2") {
  ...
  BOOST_CHECK(merkleBlock.vMatchedTxn[1].second == uint256S("0x28204cad1d7fc1d199e8ef4fa22f182de6258a3eaafe1bbe56e"
                                                            "bdcacd3069a5f"));
  BOOST_CHECK(merkleBlock.vMatchedTxn[1].first == 1);

  BOOST_CHECK(merkleBlock.vMatchedTxn[2].second == uint256S("0x6b0f8a73a56c04b519f1883e8aafda643ba61a30bd1439969df"
                                                            "21bea5f4e27e2"));
  BOOST_CHECK(merkleBlock.vMatchedTxn[2].first == 2);

  BOOST_CHECK(merkleBlock.vMatchedTxn[3].second == uint256S("0x3c1d7e82342158e4109df2e0b6348b6e84e403d8b4046d70076"
                                                            "63ace63cddb23"));
...
TEST_CASE("merkle_block_2_reversed") {
...
TEST_CASE("merkle_block_2_with_update_none") {
  // Random real block
  // (000000005a4ded781e667e06ceefafb71410b511fe0d5adc3e5a27ecbec34ae6)
  // With 4 txes
  CBlock block;
  ...
  BOOST_CHECK(merkleBlock.vMatchedTxn[2].second == uint256S("0x3c1d7e82342158e4109df2e0b6348b6e84e403d8b4046d70076"
                                                            "63ace63cddb23"));
...
TEST_CASE("merkle_block_3_and_serialize") {
  // Random real block
  // (000000000000dab0130bbcc991d3d7ae6b81aa6f50a798888dfe62337458dc45)
  // With one tx
  CBlock block;
  CDataStream stream(ParseHex("0100000079cda856b143d9db2c1caff01d1aecc8630d30625d10e8b4b8b00"
  ...
  BOOST_CHECK(merkleBlock.vMatchedTxn[0].second == uint256S("0x63194f18be0af63f2c6bc9dc0f777cbefed3d9415c4af83f3ee"
                                                            "3a3d669c00cb5"));
  BOOST_CHECK(merkleBlock.vMatchedTxn[0].first == 0);
  ...
  std::vector<uint8_t> vch = ParseHex("0100000079cda856b143d9db2c1caff01d1aecc8630d30625d10e8b4b8b00"
                                      "00000000000b50cc069d6a3e33e3ff84a5c41d9d3febe7c770fdcc96b2c3f"
  ...
  int i = 0;
  for (auto s : merkleStream) {
    BOOST_CHECK_EQUAL(s, expected[i++]);
  }
}

TEST_CASE("merkle_block_4") {
  // Random real block
  // (000000000000b731f2eef9e8c63173adfb07e41bd53eb0ef0a6b720d6cb6dea4)
  // With 7 txes
  CBlock block;
  CDataStream stream(ParseHex("0100000082bb869cf3a793432a66e826e05a6fc37469f8efb7421dc88067010000"
  ...
  BOOST_CHECK(merkleBlock.vMatchedTxn[0].second == uint256S("0x0a2a92f0bda4727d0a13eaddf4dd9ac6b5c61a1429e6b2b818f"
                                                            "19b15df0ac154"));
  ...
  BOOST_CHECK(merkleBlock.vMatchedTxn[0].second == uint256S("0x02981fa052f0481dbc5868f4fc2166035a10f27a03cfd2de673"
                                                            "26471df5bc041"));
  BOOST_CHECK(merkleBlock.vMatchedTxn[0].first == 3);
...
TEST_CASE("merkle_block_4_test_p2pubkey_only") {
  // Random real block
  // (000000000000b731f2eef9e8c63173adfb07e41bd53eb0ef0a6b720d6cb6dea4)
  // With 7 txes
  CBlock block;
...
TEST_CASE("merkle_block_4_test_update_none") {
  // Random real block
  // (000000000000b731f2eef9e8c63173adfb07e41bd53eb0ef0a6b720d6cb6dea4)
  // With 7 txes
  CBlock block;
  ...
  BOOST_CHECK(!filter.contains(COutPoint(TxId(uint256S("0x147caa76786596590baa4e98f5d9f48b"
...
TEST_CASE("rolling_bloom") {
  ...
  std::cout << "RollingBloomFilter got " << nHits << " false positives (~100 expected)\n";
  ...
  std::cout << "RollingBloomFilter got " << nHits << " false positives (~5 expected)\n";
