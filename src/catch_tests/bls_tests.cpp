...
TEST_CASE("opcodes_random_flags") {
  ...
  valtype Zero64{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
  // this is a validly-encoded 64 byte DER sig; also a valid Schnorr encoding.
  valtype DER64{0x30, 0x3e, 0x02, 0x1d, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44,
  ...
  for (int i = 0; i < 4096; i++) {
    ...
    valtype DER64_with_hashtype = SignatureWithHashType(DER64, SigHashType().withForkId(hasForkId));
    valtype Zero64_with_hashtype = SignatureWithHashType(Zero64, SigHashType().withForkId(hasForkId));
