...
public:
    ...
    //! store.
    virtual bool HaveKey(const CKeyID<0> &address) const = 0;
    virtual bool GetKey(const CKeyID<0> &address, CKey &keyOut) const = 0;
    virtual bool GetPubKey(const CKeyID<0> &address, CPubKey &vchPubKeyOut) const = 0;
    
    virtual bool HaveKey(const CKeyID<1> &address) const = 0;
    virtual bool GetKey(const CKeyID<1> &address, CKey &keyOut) const = 0;
    virtual bool GetPubKey(const CKeyID<1> &address, CPubKey &vchPubKeyOut) const = 0;
...
typedef std::map<CKeyID<1>, CKey> BLSKeyMap;
typedef std::map<CKeyID<0>, CKey> KeyMap;
typedef std::map<CKeyID<0>, CPubKey> WatchKeyMap;
typedef std::map<CKeyID<1>, CPubKey> WatchBLSKeyMap;
...
typedef std::map<CKeyID<0>, std::pair<CPubKey, std::vector<uint8_t>>>  CryptedKeyMap;
